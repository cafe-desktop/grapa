		     ...
		     GList    *file_list)
{
	...
	gtk_button_set_label (GTK_BUTTON (GET_WIDGET ("a_add_button")), _("C_reate"));
	gtk_button_set_image (GTK_BUTTON (GET_WIDGET ("a_add_button")),
	...
	gtk_widget_show (GET_WIDGET ("a_archive_type_box"));
#else
